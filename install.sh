...
sed -i 's/password_here/makeitso/g' /var/www/html/wp-config.php
#sed -i 's/localhost/mydb.cbnbkh3unm6b.ap-northeast-1.rds.amazonaws.com/g' /var/www/html/wp-config.php
sed -i 's/localhost/mydb.cxyjl4zp2xoc.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
